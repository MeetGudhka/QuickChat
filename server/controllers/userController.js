...
export const signup = async(req,res)=>{
   ...
   try{
      ...
      console.log("userController.js signup -> ",error.essage);
...
export const login=async(req,res)=>{
   try{
      ...
      console.log("userController.js login -> ",error.message);
      res.json({success: false,message: error.message});
...
export const updateProfile = async(req,res)=>{
   try{
      ...
      console.log("userController.js updateProfile -> ",error.message);
      res.json({success: false,message: error.message});
   }
}